...
"#;
    ...
    #[test]
    fn test_deployment_unknown_mode_defaults_to_local() {
        let content = r#"---
deployment:
  mode: banana
---
"#;
    ...
    #[test]
    fn test_deployment_auth_token_env_var() {
        unsafe {
            env::set_var("SYMPHONY_TEST_DEPLOY_TOKEN", "env-token-value");
        }
        let content = r#"---
deployment:
  mode: distributed
  auth_token: $SYMPHONY_TEST_DEPLOY_TOKEN
---
"#;
        let wf = parse_workflow(content).unwrap();
        let config = ServiceConfig::from_workflow(&wf).unwrap();
        ...
        unsafe {
            env::remove_var("SYMPHONY_TEST_DEPLOY_TOKEN");
        }
    }

    #[test]
    fn test_deployment_config_debug_redacts_token() {
    ...
    #[test]
    fn test_validate_distributed_missing_token() {
        let content = r#"---
tracker:
  kind: linear
  api_key: some-key
...
"#;
    ...
    #[test]
    fn test_validate_distributed_empty_token() {
        let content = r#"---
tracker:
  kind: linear
  api_key: some-key
...
"#;
    ...
    #[test]
    fn test_validate_distributed_with_token() {
        let content = r#"---
tracker:
  kind: linear
  api_key: some-key
...
"#;
    ...
    #[test]
    fn test_validate_local_no_token_ok() {
        let content = r#"---
tracker:
  kind: linear
  api_key: some-key
