...
"#;
    ...
    // --- auto_merge config tests ---

    #[test]
    fn test_github_auto_merge_true() {
        let content = r#"---
github:
  token: ghp_test
  repo: owner/name
...
"#;
    ...
    #[test]
    fn test_github_auto_merge_false() {
        let content = r#"---
github:
  token: ghp_test
  repo: owner/name
...
"#;
    ...
    #[test]
    fn test_github_auto_merge_absent_defaults_false() {
        let content = r#"---
github:
  token: ghp_test
  repo: owner/name
...
"#;
    ...
    #[test]
    fn test_github_auto_merge_case_insensitive() {
        let content = r#"---
github:
  token: ghp_test
  repo: owner/name
...
"#;
    ...
    #[test]
    fn test_github_auto_merge_non_bool_string_defaults_false() {
        let content = r#"---
github:
  token: ghp_test
  repo: owner/name
